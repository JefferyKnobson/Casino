...
const SlotMachine = () => {
  ...
  // Render betting controls - simple and clean
  const renderBettingControls = () => (
    <div className="flex flex-col items-center mt-4">
      <h3 className="font-bold mb-2 text-sm sm:text-base text-white">Select Bet</h3>
  ...
  // Render the paytable - simple and clean
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mb-6">
        ...
        <TabsContent value="game" className="mt-0">
          <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden">
            {/* Slot machine top - simple and clean */}
            <div className="bg-amber-800 p-3 text-white flex justify-between items-center border-b border-amber-900">
            ...
            {/* Slot machine body - clean design */}
            <div className="bg-zinc-900 p-4 border-b border-zinc-700">
              ...
              {(!isBroke || slotMachine.bet > 0) && (
                <>
                  {/* Reels container - simple and clean */}
                  <div className="relative mb-4 bg-black p-3 rounded-md">
                    {/* Reels */}
